...
FieldTextCode = React.createClass
  mixins: [FieldMixin]
  propTypes:
  ...
  render: ->
    ...
    inputClassName = "field-text-input field-mono #{@inputSizeClassName()}"
    ...
    return `<div className={this.displayClassName("field-text__code")}>
...
HeraclesAdmin.availableFields.add
  editorType: "text__code"
  component: FieldTextCode
