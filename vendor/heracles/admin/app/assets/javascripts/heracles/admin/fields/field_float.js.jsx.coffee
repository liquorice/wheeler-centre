...
FieldFloat = React.createClass
  mixins: [FieldMixin]
  propTypes:
    value: React.PropTypes.number
  getInitialState: ->
    field: @props.field
    value: parseFloat @props.value if @props.value?
  handleChange: (event) ->
  ...
  render: ->
    ...
    return `<div className={this.displayClassName("field-text")}>
        ...
        <div className="field-main">
          <input type="number" step="any" className="field-text-input" defaultValue={value} onChange={this.handleChange}/>
