...
(function() {
  ...
  var InsertableEventPagesDisplayMixin = _.extend({}, InsertableDisplayMixin, {
  ...
  var InsertableEventPagesDisplay = React.createClass({

    mixins: [InsertableEventPagesDisplayMixin],
  ...
  var InsertableEventPagesEditMixin = _.extend({}, InsertableEditMixin, {
    getInitialState: function() {
      var value = _.extend({}, {pages: [], page_ids: []}, this.props.value);
      return {
        value: value
  ...
  var InsertableEventPagesEdit = React.createClass({

    mixins: [InsertableEventPagesEditMixin],
          ...
          <form onSubmit={this.onSubmit}>
            ...
            <div className="field">
              ...
              <div className="field-main">
                <PagesSelector pageTypeLabel="event" pageType="event" page_ids={this.state.value.page_ids} callback={this.onPagesSelectorUpdate}/>
              </div>
            </div>
            <div className="field">
              <div className="field-header">
  ...
  HeraclesAdmin.availableInsertables.add({
    ...
    label:   "Events",
    icon:    "calendar-o",
    display: InsertableEventPagesDisplay,
    edit:    InsertableEventPagesEdit
  });
