...
(function() {
  ...
  var InsertableNextChapterBlogPostsPagesDisplayMixin = _.extend({}, InsertableDisplayMixin, {
  ...
  var InsertableNextChapterBlogPostsPagesDisplay = React.createClass({

    mixins: [InsertableNextChapterBlogPostsPagesDisplayMixin],
  ...
  var InsertableNextChapterBlogPostsPagesEditMixin = _.extend({}, InsertableEditMixin, {
    getInitialState: function() {
      var value = _.extend({}, {pages: [], page_ids: []}, this.props.value);
      return {
        value: value
  ...
  var InsertableNextChapterBlogPostsPagesEdit = React.createClass({

    mixins: [InsertableNextChapterBlogPostsPagesEditMixin],
  ...
  HeraclesAdmin.availableInsertables.add({
    type:    "next_chapter_blog_posts_pages",
    label:   "Next Chapter blog posts",
    icon:    "file-text",
    display: InsertableNextChapterBlogPostsPagesDisplay,
    edit:    InsertableNextChapterBlogPostsPagesEdit
  });
