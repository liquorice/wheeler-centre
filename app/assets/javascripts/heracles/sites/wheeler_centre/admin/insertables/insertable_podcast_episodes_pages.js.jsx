...
(function() {
  ...
  var InsertablePodcastEpisodesPagesDisplayMixin = _.extend({}, InsertableDisplayMixin, {
  ...
  var InsertablePodcastEpisodesPagesDisplay = React.createClass({

    mixins: [InsertablePodcastEpisodesPagesDisplayMixin],
    ...
    formatPages: function() {
      if (this.state.value.pages && this.state.value.pages.length > 0) {
          ...
          <div className="insertable-display-pages__content">
            <div className="insertable-display-pages__pages">
              <dl className="field-details-list">
                <dt>Selected podcast episodes</dt>
                <dd>
        ...
        return (
          <p className="insertable-display-pages__empty">No podcast episodes selected</p>
        );
      }
    }
  ...
  var InsertablePodcastEpisodesPagesEditMixin = _.extend({}, InsertableEditMixin, {
    getInitialState: function() {
      var value = _.extend({}, {pages: [], page_ids: []}, this.props.value);
      return {
        value: value
  ...
  var InsertablePodcastEpisodesPagesEdit = React.createClass({

    mixins: [InsertablePodcastEpisodesPagesEditMixin],

    render: function() {
      return (
        <div className="insertable-edit fields--reversed">
          <form onSubmit={this.onSubmit}>
            <h2 className="insertable-edit__title">Edit insertable podcast episodes</h2>
            <div className="field">
            ...
            <button type="submit" className="button button--highlight">Save changes to podcast episodes insertable</button>
          </form>
        </div>
      );
    },
  ...
  HeraclesAdmin.availableInsertables.add({
    type:    "podcast_episodes_pages",
    label:   "Podcast episodes",
    icon:    "microphone",
    display: InsertablePodcastEpisodesPagesDisplay,
    edit:    InsertablePodcastEpisodesPagesEdit
  });
