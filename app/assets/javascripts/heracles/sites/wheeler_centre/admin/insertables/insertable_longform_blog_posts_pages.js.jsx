...
(function() {
  ...
  var InsertableLongformBlogPostsPagesDisplayMixin = _.extend({}, InsertableDisplayMixin, {
  ...
  var InsertableLongformBlogPostsPagesDisplay = React.createClass({

    mixins: [InsertableLongformBlogPostsPagesDisplayMixin],
    ...
    formatPages: function() {
      if (this.state.value.pages && this.state.value.pages.length > 0) {
          ...
          <div className="insertable-display-pages__content">
            <div className="insertable-display-pages__pages">
              <dl className="field-details-list">
                <dt>Selected longform blog posts</dt>
                <dd>
        ...
        return (
          <p className="insertable-display-pages__empty">No longform blog posts selected</p>
        );
      }
    }
  ...
  var InsertableLongformBlogPostsPagesEditMixin = _.extend({}, InsertableEditMixin, {
    getInitialState: function() {
      var value = _.extend({}, {pages: [], page_ids: []}, this.props.value);
      return {
        value: value
  ...
  var InsertableLongformBlogPostsPagesEdit = React.createClass({

    mixins: [InsertableLongformBlogPostsPagesEditMixin],

    render: function() {
      return (
        <div className="insertable-edit fields--reversed">
          <form onSubmit={this.onSubmit}>
            <h2 className="insertable-edit__title">Edit insertable longform blog posts</h2>
            <div className="field">
              <div className="field-header">
                <label className="field-label" htmlFor="edit__caption">Longform blog posts</label>
              </div>
              <div className="field-main">
                <PagesSelector pageTypeLabel="longform blog post" pageType="longform_blog_post" page_ids={this.state.value.page_ids} callback={this.onPagesSelectorUpdate}/>
              </div>
            </div>
            <div className="field">
              <div className="field-header">
            ...
            <button type="submit" className="button button--highlight">Save changes to longform blog posts insertable</button>
          </form>
        </div>
      );
    },
  ...
  HeraclesAdmin.availableInsertables.add({
    type:    "longform_blog_posts_pages",
    label:   "Longform Blog posts",
    icon:    "file-text",
    display: InsertableLongformBlogPostsPagesDisplay,
    edit:    InsertableLongformBlogPostsPagesEdit
  });
