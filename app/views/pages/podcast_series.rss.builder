...
cache_time = Time.at((Time.now.to_f / cache_period).floor * cache_period).utc
cache ["podcast-series-1", page, cache_time] do
  ...
  episodes = page.episodes(type: type, per_page: 2000)
